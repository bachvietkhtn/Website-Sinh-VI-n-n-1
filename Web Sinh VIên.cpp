...
//{
	...
	//	if (ch == L'"')
		...
		//	break;
	//}
	//return count1 / 2; // Số sở thích bằng số dấu nháy chia 2
//}

//void Docsothich(FILE*fin, int &m)
//{
//	int Vitri = ftell(fin);
//	m = Demsothich(fin);
//	SINHVIEN sv;
...
//	else
//	{
//		sv.Sothich = (wchar_t**)malloc(m*sizeof(wchar_t*));
//		fseek(fin, Vitri, SEEK_SET);
//		for (int i = 0; i < m; i++)
//		{
//			sv.Sothich[i] = (wchar_t*)malloc(1000*sizeof(wchar_t));
//			fwscanf(fin, L",\"%[^\"\n]", sv.Sothich[i]);
//		}
//	}
//}
